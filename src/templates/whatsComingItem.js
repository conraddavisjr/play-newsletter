                    ...
                    <table cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr>
                        <td valign="top">
                          <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td valign="bottom" style="color:#00bf60; font-size:24px;font-family: 'Roboto',Helvetica,Arial,sans-serif;letter-spacing:normal;line-height: 26px; text-align: left; font-weight: 500; text-transform: uppercase;"> Games</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
